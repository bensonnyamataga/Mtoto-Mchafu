...
<body>
    ...
    <section class="about-section" id="about">
        <div class="container">
            <div class="section-title">
                ...
                <h2>About Deep Tanzania</h2>
            </div>
            
            <div class="about-text">
                <h2>Your Authentic Tanzanian Adventure</h2>
                <p>Welcome to Deep Tanzania, a locally-owned tour company based in Tanzania, specializing in creating unforgettable safari experiences and Mount Kilimanjaro treks. We offer personalized adventures that showcase Tanzania's spectacular natural beauty and rich cultural heritage.</p>
                
                <p>Our experienced team is dedicated to providing authentic, eco-friendly journeys whether you're seeking wildlife encounters on safari, the challenge of conquering Africa's highest peak, or meaningful connections with local communities. At Deep Tanzania, we take pride in crafting tailored tours that reflect our deep commitment to responsible travel and our passion for Tanzania's wonders.</p>
    ...
    <script>
        ...
        mobileCurrentLanguage.addEventListener('click', function(e) {
            e.stopPropagation();
        ...
        languageOptions.forEach(option => {
            option.addEventListener('click', function() {
                ...
                mobileCurrentLanguage.innerHTML = `
                    <span class="${flagClass}"></span>
                    <span>${languageCode}</span>
                    <i class="fas fa-chevron-down" style="font-size: 12px;"></i>
                `;
                ...
                // 1. Save the language preference to localStorage
                localStorage.setItem('preferred-language', lang);
                
                // 2. Redirect to the language-specific page or reload content
                // window.location.href = `?lang=${lang}`;
                
                // 3. Or use a translation API to update content dynamically
