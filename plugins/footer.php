...
<?php include 'plugins/mobile-footer.php';?>
 ...
 <footer id="contact">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 Deep Tanzania Tanzania. All Rights Reserved. | <a href="#">Privacy Policy</a> | <a href="terms-and-condition.php">Terms of Service</a></p>
            </div>
        </div>
    </footer>
 ...
 #contact {
            background: 
                linear-gradient(rgba(246, 244, 242, 0.85), rgba(246, 244, 242, 0.9)),
                url('img/savana.png');
