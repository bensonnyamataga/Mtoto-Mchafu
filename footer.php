        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <h3>About Deep Tanzania Tours</h3>
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 Deep Tanzania Tours Tanzania. All Rights Reserved. | <a href="#" style="color: var(--secondary);">Privacy Policy</a> | <a href="terms-and-condition.php" style="color: var(--secondary);">Terms of Service</a></p>
            </div>
        </div>
    </footer>